...
- [TNNLS 2025] **Federated Graph Neural Networks: Overview, Techniques and Challenges**  
  [paper](https://ieeexplore.ieee.org/document/10733611)

- [arXiv 2024] **OpenFGL: A Comprehensive Benchmarks for Federated Graph Learning**  
...
- [ICDM 2022] **GraphFL: A Federated Learning Framework for Semi-Supervised Node Classification on Graphs**  
  [paper](https://ieeexplore.ieee.org/document/10027642)

- [Information Sciences 2024] **FedGL: Federated Graph Learning Framework with Global Self-Supervision**  
  [paper](https://www.sciencedirect.com/science/article/pii/S002002552301561X)

- [NeurIPS 2023] **FedGCN: Convergence-Communication Tradeoffs in Federated Training of Graph Convolutional Networks**  
  [paper](https://proceedings.neurips.cc/paper_files/paper/2023/hash/fc07feae9af49dd3f1a1e049b77f4e17-Abstract-Conference.html)

- [arXiv 2024] **Optimizing Federated Graph Learning with Inherent Structural Knowledge and Dual-Densely Connected GNNs**  
...
- [arXiv 2022] **Federated Learning on Non-IID Graphs via Structural Knowledge Sharing**  
...
- [NeurIPS 2024] **FedSSP: Federated Graph Learning with Spectral Knowledge and Personalized Preference**  
...
- [IJCAI 2023] **Federated Graph Semantic and Structural Learning**  
  [paper](https://www.ijcai.org/proceedings/2023/426)

- [ICLR 2025] **Subgraph Federated Learning for Local Generalization**  
...
- [DASFAA 2024] **FedSig: A Federated Graph Augmentation for Class-Imbalanced Node Classification**  
  [paper](https://link.springer.com/chapter/10.1007/978-981-97-5552-3_32)
...
- [ICML 2023] **Vertical Federated Graph Neural Network for Recommender System**  
  [paper](https://proceedings.mlr.press/v202/mai23b.html)

- [arXiv 2023] **FedDCSR: Federated Cross-domain Sequential Recommendation via Disentangled Representation Learning**  
  [paper](https://arxiv.org/abs/2309.08420)

- [arXiv 2024] **FedHCDR: Federated Cross-Domain Recommendation with Hypergraph Signal Decoupling**  
  [paper](https://arxiv.org/abs/2403.02630)
